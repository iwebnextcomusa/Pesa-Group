  ...
  const hrgil_pillars = [
    {
      ...
      desc: "Acquiring premier consulting partners and multi-national advisory specialists to drive structural solutions.",
      icon: UserPlus
    },
    {
      title: "Capacity Upskilling",
      desc: "Delivering continuous professional development programs to align local subcontractor networks with world-class metrics.",
      icon: GraduationCap
    },
    {
      title: "Meritocratic Advancement",
      desc: "Structuring fair, transparent career paths where promotions and rewards are based purely on hard work and on-time results.",
      icon: Award
    },
    {
      title: "Employee Engagement",
      desc: "Fostering collaboration across our Dallas and Kinshasa divisions to ensure perfect team harmony and a shared corporate vision.",
      icon: Heart
    }
  ];

  const jobsList = [
    { id: "sba-tx", title: "Senior Business Analyst", location: "Dallas, TX // Hybrid", dept: "Strategy & Advisory", type: "Full-Time", salary: "$115k - $140k" },
    { id: "mla-kin", title: "Managing Logistics Auditor", location: "Kinshasa, DRC // On-site", dept: "Audit & Compliance", type: "Full-Time", salary: "Regional Contract" },
    { id: "ste-tx", title: "Strategic Technology Engineer", location: "Dallas, TX // Remote US", dept: "Technology Consulting", type: "Full-Time", salary: "$130k - $165k" },
    { id: "gmc-kin", title: "Global Marketing Coordinator", location: "Kinshasa, DRC // Hybrid", dept: "Marketing & Strategy", type: "Contract (5+ Years)", salary: "Competitive Commission" }
  ];
    ...
    <div className="flex-1 animate-fade-in py-20 bg-slate-50" id="hr-page-root">
      ...
      <section className="py-20" id="hr-pillars">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[10px] font-mono text-blue-600 uppercase tracking-widest font-bold">Our Talent Framework</span>
            <h2 className="font-sans text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mt-1">
              How We Cultivate Executive Performance
            </h2>
      ...
      <section className="py-20 bg-slate-100 border-y border-slate-200" id="hr-open-positions">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[10px] font-mono text-blue-600 uppercase tracking-widest font-bold">Join Our Ranks</span>
            <h2 className="font-sans text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mt-1">
              ...
              >
                <div className="space-y-1.5 flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-400 font-sans">
                    Location: {job.location} // Target Comp: {job.salary}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-6 sm:p-10 space-y-6">
            ...
            {formSubmitted ? (
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 text-center text-emerald-800 space-y-2 animate-fade-in font-sans">
                ...
                <h5 className="font-bold text-sm font-sans">Application Received Successfully</h5>
                <p className="text-xs">Your files have been securely indexed. Our HR committee will review and reach out within 5 business days if aligned.</p>
              </div>
            ) : (
              <form onSubmit={handleFormSubmit} className="space-y-4" id="job-apply-form">
                ...
                {selectedJob && (
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-800 font-sans font-bold flex items-center justify-between">
                    <span>Applying For: {selectedJob}</span>
                    <button 
                      type="button" 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-wider block font-bold">Personal Email Address *</label>
                    <input 
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-wider block font-bold">Selected Job Title (If applicable)</label>
                    <input 
                      type="text"
                      value={selectedJob}
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-wider block font-bold">Resume Link / OneDrive Path *</label>
                    <input 
                      type="text"
                      required
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-mono text-slate-500 uppercase tracking-wider block font-bold">Professional Statement & Alignment *</label>
                  <textarea 
                    required
                    rows={4}
                    value={formData.statement}
                    onChange={(e) => setFormData({...formData, statement: e.target.value})}
                    placeholder="Briefly describe how your experience aligns with PESA's values of absolute rigor and timeliness..."
                ...
                <div className="p-3 bg-slate-50 border border-slate-150 rounded-lg flex items-start gap-2.5 text-[10px] text-slate-500 leading-normal font-sans">
                  ...
                  <span>By submitting, you authorize PESA's hiring board to verify referenced credentials and conduct secure background compliance checks. We do not charge fees during any phase of candidate screening.</span>
                </div>
